...
| **Connections and curvature** | Conservation says money is never created or destroyed. Flatness is the stronger claim that the path doesn't matter. Only the first is always true. Non-flat connections handle discrepancies, float, and arbitrage without abandoning conservation. | [Why connections and curvature?](curvature.md) |
