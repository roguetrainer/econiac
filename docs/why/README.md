...
| **Clearing and netting** | Bilateral netting removes edges from the exposure graph. CCP novation fills in a triangle. A genuine H² obstruction cannot be resolved by either — it requires a four-party instrument that fills in a tetrahedron. The 2008 crisis reached that level; only government intervention resolved it. | [Clearing, netting, and the topology of obligation](../concepts/clearing.md) |
